...
// استيراد الإطار العام (الهيدر والفوتر)
...
export default function LoginPage() {
  ...
  return (
    <LayoutFrame>
      <div dir="rtl" style={{ minHeight: '80vh', background: COLORS.navy, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Tajawal', sans-serif", color: COLORS.white, position: 'relative', overflow: 'hidden', padding: '40px 0' }}>
        <style>{`
        ...
        <div className={styles.card}>
          ...
          <form onSubmit={handleAuth} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {/* Input Fields (Email, Password, etc.) remain the same */}
            <div>
          ...
          <div style={{ marginTop: 28, textAlign: 'center', fontSize: 13, color: COLORS.muted }}>
            ...
            <button type="button" onClick={() => setIsSignUp(!isSignUp)} style={{ background: 'none', border: 'none', color: COLORS.gold2, fontWeight: 700, cursor: 'pointer', padding: 0, textDecoration: 'underline' }}>
